...
package gradle.kotlin.dsl.plugins._a1a70b066cc62922378725bc1d44218a
...
/**
 * The `com.install4j` plugin group.
 */
@org.gradle.api.Generated
internal
class `ComInstall4jPluginGroup`(internal val plugins: PluginDependenciesSpec)


/**
 * Plugin ids starting with `com.install4j`.
 */
internal
val `ComPluginGroup`.`install4j`: `ComInstall4jPluginGroup`
    get() = `ComInstall4jPluginGroup`(plugins)


/**
 * The `com.install4j.gradle` plugin implemented by [com.install4j.gradle.Install4jPlugin].
 */
internal
val `ComInstall4jPluginGroup`.`gradle`: PluginDependencySpec
    get() = plugins.id("com.install4j.gradle")
...
/**
 * The `edu` plugin group.
 */
@org.gradle.api.Generated
internal
class `EduPluginGroup`(internal val plugins: PluginDependenciesSpec)


/**
 * Plugin ids starting with `edu`.
 */
internal
val `PluginDependenciesSpec`.`edu`: `EduPluginGroup`
    get() = `EduPluginGroup`(this)


/**
 * The `edu.sc` plugin group.
 */
@org.gradle.api.Generated
internal
class `EduScPluginGroup`(internal val plugins: PluginDependenciesSpec)


/**
 * Plugin ids starting with `edu.sc`.
 */
internal
val `EduPluginGroup`.`sc`: `EduScPluginGroup`
    get() = `EduScPluginGroup`(plugins)


/**
 * The `edu.sc.seis` plugin group.
 */
@org.gradle.api.Generated
internal
class `EduScSeisPluginGroup`(internal val plugins: PluginDependenciesSpec)


/**
 * Plugin ids starting with `edu.sc.seis`.
 */
internal
val `EduScPluginGroup`.`seis`: `EduScSeisPluginGroup`
    get() = `EduScSeisPluginGroup`(plugins)


/**
 * The `edu.sc.seis.launch4j` plugin implemented by [edu.sc.seis.launch4j.Launch4jPlugin].
 */
internal
val `EduScSeisPluginGroup`.`launch4j`: PluginDependencySpec
    get() = plugins.id("edu.sc.seis.launch4j")
...
/**
 * The `me.champeau.gradle.japicmp` plugin implemented by [me.champeau.gradle.japicmp.JapicmpPlugin].
 */
internal
val `MeChampeauGradlePluginGroup`.`japicmp`: PluginDependencySpec
    get() = plugins.id("me.champeau.gradle.japicmp")
